...
public class JapaneseSync {
    private static Logger LOG = LoggerFactory.getLogger(JapaneseSync.class);
    ...
    public static void main(String[] args) {
        ...
        try (InputStream in = gzipHttpClient.download(vocabUrl).openStream();
    ...
    private static void transactUpdate(List<Vocabulary> vocabularies, DynamoDbClient dbClient) {
